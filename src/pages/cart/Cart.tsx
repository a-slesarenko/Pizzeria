            ...
            <div className={`container ${styles.cart__container}`}>
                ...
                <ul className={styles.items}>
                    {cart.cartPizzas.map((pizza) => {
                        return (
                            <li key={pizza.calculatedPrice} className={styles.item}>
                                ...
                                <div className={styles.counter}>
                                    <button className={styles.counter__button} onClick={() => dispatch(decrementPizza(pizza))}>
                                        <SmallMinus className={styles.minus} />
                                    </button>
                                    <span>{pizza.count}</span>
                                    <button className={styles.counter__button} onClick={() => dispatch(addPizza(pizza))}>
                                        <SmallPlus className={styles.plus} />
                                    </button>
                                </div>
                                <div className={styles.price}>{pizza.calculatedPrice * pizza.count} ₽</div>
                                <button className={styles.remove__button} onClick={() => dispatch(removePizza(pizza))}>
                ...
                <div className={styles.cart__bottom}>
                    <div className={styles.details}>
                        <span>Всего пицц: <b>{cart.totalPizzas}</b></span>
